...
Now that we've written our extension, we can deploy it to RStudio Connect so that it can be called from Tableau. 

- To read more about using extensions on RStudio Connect, see **[Publishing plumbertableau Extensions](publishing-extensions.html)**.
- For more information about using extensions from Tableau
