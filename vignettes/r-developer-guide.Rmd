...
`plumbertableau` automatically provides a simple mock request that follows the specification provided by Tableau. This initial mock request contains simple `script` and `data` values. If you'd like, you can use `mock_tableau_request()` to create a more full-featured request for use with Swagger:
