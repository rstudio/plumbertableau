...
- Tableau extensions are only supported in recent version of RStudio Connect. See the [RStudio Connect release notes](https://docs.rstudio.com/connect/news/) to determine the minimum version with support for Tableau extensions.
