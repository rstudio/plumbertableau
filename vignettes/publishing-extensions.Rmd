...
## Configuring RStudio Connect as an Extension Server in Tableau #{tableau}

Before you can use extensions hosted on an RStudio Connect server from Tableau, you'll need to register that server in Tableau's Extensions settings. you'll need to set up  The steps to set Tableau differ slightly depending on whether you're using Tableau Desktop or Tableau and Online.
...
### Tableau Server / Tableau Online
  ...
  5. Select whether you want to use SSL and enter the server Host and Port for your RStudio Connect server
...
If you're using Tableau Desktop, you don't need to use authetication if you're using an extension running locally in R.
